...
![Data Engineering Process Fundamentals - Terraform](images/ozkary-data-engineering-terraform.png "Data Engineering Process - Terraform"){height=80%}
...
![Data Engineering Process Fundamentals - GCP Roles Configuration](images/ozkary-data-engineering-gcp-roles.png){height=80%}
...
![Scan the QR Code to load the GitHub project](images/qr-ozkary-data-engineering-process-fundamentals-design.png){height=6cm}
...
![Data Engineering Process Fundamentals - Terraform Lifecycle](images/ozkary-data-Engineering-terraform-lifecycle.png "Data Engineering Process - Terraform Lifecycle"){height=80%}
