...
![Scan the QR Code to load the GitHub project](images/qr-ozkary-data-engineering-process-fundamentals-home.png "Data Engineering Process Fundamentals GitHub Project"){height=7cm}
